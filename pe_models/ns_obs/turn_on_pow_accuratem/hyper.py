...
import utilizes
npool=80
NN=int(len(data_exp)/5000) + 0
nlive=400
mx=5000
#################################
data_df=list()
#ns_m=np.concatenate([data_exp, np.random.normal(2.6,0.01,5000)])
ns_m=data_exp
for i in range(NN):
